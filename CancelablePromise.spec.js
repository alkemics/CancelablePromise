...
describe(__filename, () => {
      ...
      .then(
        () => {
          hasFailed = true;
            ...
            new Error(
              "Promise's children success callback should not be executed"
            )
          );
        },
        reason => {
          hasFailed = true;
            ...
            new Error(
              "Promise's children error callback should not be executed"
            )
          );
        }
      );

    const resolvedPromise = CancelablePromise.resolve(
  ...
  it('should reject the promise when the success callback throws an error', done => {
    ...
    const end = () => {
        ...
        hasFailed
          ? new Error(
              'Promise should be rejected when the success callback throws an error'
            )
          : undefined
      );
    };
  ...
  it('should reject the promise when the error callback throws an error', done => {
    ...
    const end = () => {
        ...
        hasFailed
          ? new Error(
              'Promise should be rejected when the error callback throws an error'
            )
          : undefined
      );
    };
  ...
  it('should call cancel function if rejected after a cancel', done => {
    ...
    const end = () => {
      ...
      if (catchCalled) {
        hasFailed =
          'Promise should NOT call catch when rejected after a cancel';
